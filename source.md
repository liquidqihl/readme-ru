...
5. Вы успешно привязали ваш Steam аккаунт.  
...
Используйте приведённые ниже команды **ТОЛЬКО** в каналах `#[rank]-lobbies` или `#[rank]-lobbies-[region]` (то есть, `#master-lobbies`, `#intermediate-lobbies-ru` и т.д.).
